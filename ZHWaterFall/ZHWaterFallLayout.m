...
- (UIEdgeInsets)edgeInsets{
    if ([self.delegate respondsToSelector:@selector(edgeInsetsOfZHWaterFallLayout:)]) {
        return [self.delegate edgeInsetsOfZHWaterFallLayout:self];
    } else {
...
- (NSInteger)columnCount{
    if ([self.delegate respondsToSelector:@selector(columnCountOfZHWaterFallLayout:)]) {
        return [self.delegate columnCountOfZHWaterFallLayout:self];
    } else {
...
/** 行间距 */
- (CGFloat)rowMargin{
    if ([self.delegate respondsToSelector:@selector(rowMarginOfZHWaterFallLayout:)]) {
        return [self.delegate rowMarginOfZHWaterFallLayout:self];
    } else {
...
- (CGFloat)columnMargin{
    if ([self.delegate respondsToSelector:@selector(columnMarginOfZHWaterFallLayout:)]) {
        return [self.delegate columnMarginOfZHWaterFallLayout:self];
    } else {
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat h = [self.delegate zhWaterFallLayout:self heightForItemAtIndexPath:indexPath itemWidth:w];
